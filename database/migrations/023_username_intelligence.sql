-- Sprint 6E: Username Intelligence Scan
-- Revisionssichere Speicherung + Katalog + Modul-Einstellungen
...
CREATE TABLE IF NOT EXISTS `username_analysis` (
  ...
  CONSTRAINT `username_analysis_user_id_fk`
...
CREATE TABLE IF NOT EXISTS `username_hits` (
  ...
  CONSTRAINT `username_hits_analysis_id_fk`
    FOREIGN KEY (`analysis_id`) REFERENCES `username_analysis` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `username_reports` (
  ...
  CONSTRAINT `username_reports_analysis_id_fk`
    FOREIGN KEY (`analysis_id`) REFERENCES `username_analysis` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `username_ai_reports` (
  ...
  CONSTRAINT `username_ai_reports_analysis_id_fk`
    FOREIGN KEY (`analysis_id`) REFERENCES `username_analysis` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `username_cost_logs` (
  ...
  CONSTRAINT `username_cost_logs_analysis_id_fk`
    FOREIGN KEY (`analysis_id`) REFERENCES `username_analysis` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
