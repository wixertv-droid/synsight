...
import PlatformSessionGate from "@/components/session/PlatformSessionGate";
import type { AuthenticatedUser } from "@/lib/auth/types";
import { canAccessOrdersDesk, isStaffRole } from "@/lib/admin/permissions";
...
export default function DashboardShell({
  ...
  const showCenterActions = staff || canAccessOrdersDesk(user.role);
    ...
    <PlatformSessionGate>
      <div className="min-h-screen bg-space-black text-white">
        ...
        <div className="relative z-10 lg:pl-[278px]">
          <header className="sticky top-0 z-30 grid h-16 grid-cols-[1fr_auto_1fr] items-center border-b border-white/[0.06] bg-[#03070e]/75 px-5 backdrop-blur-xl md:px-8 lg:px-10">
            ...
            <div className="flex items-center justify-center gap-2 justify-self-center sm:gap-3">
              {showCenterActions ? (
                <>
