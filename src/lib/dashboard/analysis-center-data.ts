...
export const analysisModules: AnalysisModule[] = [
  ...
  },
  {
    ...
    whatYouGet: [
      "Bestätigte Leak-Treffer (DeHashed)",
    ...
    tier: "quick",
    badge: "Neu",
    help: "Ersetzt die getrennten Telefon- und E-Mail-Analysen durch eine gemeinsame Exposure-Prüfung. Benötigt konfigurierte DeHashed.com API.",
  ...
  },
  {
    ...
    tagline: "Wo im Netz tauchen öffentlich auffindbare Bilder auf?",
    description:
      "Eigenständiges Modul für öffentliche Bildfunde: priorisierte Suchanfragen (Benutzername → Alias → Name), gruppierte Treffer und Kontextbewertung ohne Gesichtsvergleich.",
    whatYouGet: [
      "Gespeicherte öffentliche Bildkandidaten nach Suchbegriff",
      "Gruppierte Quellen inkl. Domain-/Kontextübersicht",
      "Grundlage für spätere Face Identity Verification",
    ],
    duration: "ca. 1–3 Min.",
    tier: "advanced",
    help: "Dieses Modul führt nur die Bildsuche und Kontextanalyse durch. Kein Face-Match in diesem Schritt.",
  ...
  },
  {
    ...
    tagline: "Vergleicht vorhandene Bilder mit Ihren Referenzfotos.",
    description:
      "Eigenständiges Verifikationsmodul: kein Crawling, nur Face-Matching über bereits gespeicherte Bildkandidaten oder zukünftige Upload-Quellen.",
    whatYouGet: [
      "Ähnlichkeitswerte je Bild",
      "Trefferstatus (wahrscheinlich/unsicher/kein Treffer)",
      "Priorisierte Treffer für den Maßnahmenplan",
    ],
    duration: "ca. 1–5 Min.",
    tier: "advanced",
    help: "Verwendet ausschließlich vorhandene Kandidatenbilder und Profil-Referenzbilder.",
    icon: "M12 3a9 9 0 100 18 9 9 0 000-18zm0 4a3 3 0 110 6 3 3 0 010-6zm-5 9a5 5 0 0110 0",
    accent: "from-violet-300/15 to-transparent",
  },
  {
    id: "ai_summary",
