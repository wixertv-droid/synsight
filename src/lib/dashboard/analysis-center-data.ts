...
export const analysisModules: AnalysisModule[] = [
  ...
  },
  {
    ...
    description:
      "Zwei Phasen: Zuerst durchsucht SynSight Google Images nach Name, Alias und Benutzernamen. Danach wählen Sie Bildlinks aus und starten optional den InsightFace-Gesichtsvergleich.",
    whatYouGet: [
      "Gespeicherte Bildlinks nach Name/Alias/Benutzername",
      "Filterbare Quellenliste im Ergebnis Center",
      "Optionaler Gesichtsvergleich gegen Referenzfotos",
    ],
    duration: "ca. 1–3 Min. (Bildsuche)",
    tier: "advanced",
    help: "Phase 1 benötigt Name oder Benutzername im Profil. Phase 2 (Gesichtsvergleich) benötigt Referenzbilder und wird separat berechnet.",
