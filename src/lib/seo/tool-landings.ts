...
export const TOOL_LANDINGS: ToolLanding[] = [
  ...
  },
  {
    ...
    dataSources: ["Öffentliche Webquellen", "Breach-/Leak-Hinweise (sofern lizenziert)"],
    faqs: [
      {
  ...
  },
  {
    ...
    dataSources: ["Öffentliche Bildersuchen / APIs", "Verlinkte Seitenkontexte"],
    faqs: [
      {
    ...
    relatedSlugs: ["social-media-analyse", "personensuche", "digital-footprint"],
  ...
  },
  {
    ...
    dataSources: ["Öffentliche Registrierungssignale", "Lizenzierte Leak-Quellen"],
    faqs: [
      {
  ...
  },
  {
    ...
    dataSources: ["Öffentliche Nummernbibliotheken", "OSINT-Tools ohne HLR-Missbrauch"],
    faqs: [
      {
  ...
  },
  {
    ...
    whoFor: ["Privatpersonen", "Journalistische Recherche (ethisch)", "HR/Trust (mit Rechtsgrundlage)"],
    ...
    faqs: [
      {
        ...
        answer:
          "Nein. Es gibt keinen Zugriff auf behördliche Melderegister.",
      },
      {
