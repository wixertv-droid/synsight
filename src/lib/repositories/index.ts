...
import { createSeoKnowledgeRepository } from "./mysql/seo-knowledge-repository";
...
import type { SeoKnowledgeRepository } from "./seo-knowledge-repository";
...
export function getPricingRepository(): PricingRepository {
  return createPricingRepository(getDatabase());
}

export function getPromotionsRepository(): PromotionsRepository {
  return createPromotionsRepository(getDatabase());
}
...
export function getSeoKnowledgeRepository(): SeoKnowledgeRepository {
  return createSeoKnowledgeRepository(getDatabase());
}
