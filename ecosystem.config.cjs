  ...
  apps: [
    {
      ...
      env: {
        ...
        CONTACT_EMAIL: merged.CONTACT_EMAIL || "contact@synsight.de",
        PRESS_EMAIL: merged.PRESS_EMAIL || "press@synsight.de",
        PARTNER_EMAIL: merged.PARTNER_EMAIL || "partners@synsight.de",
